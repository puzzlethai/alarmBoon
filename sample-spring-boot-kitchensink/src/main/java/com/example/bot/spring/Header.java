...
/*                "    @font-face {\n" +
                ...
                "    <tr bgcolor=\"#57b33e\">\n" +
                "        <td colspan=\"4\" style=\"font-family:'Ubuntu'; font-size: large; padding: 15px;color:white\"><span>Oil Price Change<small> with the courtesy of Bangchak<small></span></td></tr>\n" +
